...
const Footer = () => {
  return (
    <div className="h-fit w-full flex flex-col items-center justify-start relative gap-12">
      {/* Mobile footer Nav */}
      <div className="w-full h-fit relative flex justify-end items-baseline md:hidden mt-[20vh]">
        <FooterNav />
      </div>
      ...
      <div
        className="items-center justify-center p-4 absolute bottom-[30vh] right-0 bg-white cursor-pointer md:flex hidden z-10"
        onClick={() => {
          window.scrollTo({
            top: 0,
            behavior: "smooth",
