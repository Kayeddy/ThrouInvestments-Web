...
} from "./chunk-PBXGYTE3.js";
import {
  require_safe_buffer
} from "./chunk-IUTF2UZD.js";
import {
  require_buffer
...
var RistrettoPoint = class {
  ...
  static fromHex(hex) {
    ...
    if (!isValid || isNegativeLE(t, P) || y === _0n6)
      throw new Error(emsg);
    return new RistrettoPoint(new ed25519.ExtendedPoint(x, y, _1n6, t));
  }
  /**
...
function SWUFpSqrtRatio(Fp3, Z) {
  ...
  for (let o = q - _1n8; o % _2n6 === _0n8; o /= _2n6)
    l += _1n8;
  const c1 = l;
  const c2 = (q - _1n8) / _2n6 ** c1;
  const c3 = (c2 - _1n8) / _2n6;
  const c4 = _2n6 ** c1 - _1n8;
  const c5 = _2n6 ** (c1 - _1n8);
...
var { hashToCurve: hashToCurve2, encodeToCurve: encodeToCurve2 } = createHasher(secp256k1.ProjectivePoint, (scalars) => {
