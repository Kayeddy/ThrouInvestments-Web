    ...
    <div className="">
      <div className="flex md:flex-row flex-col justify-around">
        <div className="flex flex-col items-start justify-start gap-4">
          <h2 className="text-[40px] font-bold dark:text-white text-[#01070E] font-sen">
            Nombre del proyecto
          </h2>
          ...
          <p className="max-w-[80%] dark:text-[#F7FAFF] md:text-[18px] text-[14px] text-[#01070E] font-light font-jakarta">
          ...
          <div className="flex md:flex-row flex-col items-center justify-start gap-3 w-full">
            <p className="text-[20px] text-[#B5B5B5] dark:text-white hidden md:block font-jakarta">
              {" "}
              Categoría:{" "}
            </p>
            <span className="rounded-md text-white p-2 bg-[#76DBDB] hidden md:flex items-center justify-center">
              <p className="text-[20px] font-jakarta">Categoría</p>
            </span>
