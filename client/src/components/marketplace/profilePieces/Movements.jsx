...
import { Throu_sm_dark, Throu_sm } from "../../../assets";
...
const Movements = () => {
  return (
    <div className="flex flex-col w-full h-fit">
      ...
      <div className="flex flex-row items-center justify-between w-full gap-12 mt-[20px] font-jakarta">
        <div className="flex flex-row items-center gap-6 w-full">
          <div className="flex flex-row items-center justify-start gap-2 flex-wrap">
            <img src={Throu_sm} alt="Throu_icon" className="w-10 h-10" />
      ...
      <div className="flex items-center justify-center mt-[50px]">
        <p className="text-[20px] md:text-[16px] text-[#18A5FF] cursor-pointer hover:underline hover:font-bold font-sen">
          {" "}
          Cargar más{" "}
        </p>
      </div>
