...
const CampaignDisplayCard = ({
  ...
  return (
    <div className="md:max-w-[500px] w-full h-fit dark:bg-transparent bg-[#F7FAFF] dark:bg-opacity-0  rounded-sm cursor-pointer">
      ...
      <div className="mt-2 flex flex-col items-start justify-center w-full gap-4 px-3 dark:text-white text-[#062147] font-bold md:font-normal">
        <h3 className="text-[25px] md:text-[20px]"> Nombre </h3>
        <div className="flex flex-row items-center justify-between gap-4 w-full">
          {[
            ...
            <div className="max-w-[60px] w-[30%] h-[50px] py-2 dark:bg-[#01070E] bg-[#F7FAFF] backdrop-blur-lg rounded-lg shadow-[0px_0px_10px_rgba(24,165,255,0.2)] flex flex-col items-center justify-center">
              <h3 className="text-[15px]"> {item.amount} </h3>
      ...
      <div className="flex flex-col items-start justify-center w-full dark:text-white text-black px-3 font-bold md:font-normal">
        <p className="leading-[20px] text-[14px] mt-4 w-[90%]">
          Purus egestas id aenean non accumsan fames in eu
        </p>
        <p className="leading-[20px] text-[14px] mt-4 flex flex-row justify-center items-center gap-1">
      ...
      <div className="w-full flex flex-col gap-1 mt-4 px-3">
