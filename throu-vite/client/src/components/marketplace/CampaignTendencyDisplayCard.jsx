...
const CampaignTendencyDisplayCard = ({
  ...
  return (
    ...
    >
      <div className="flex flex-col flex-wrap relative w-full group">
        <img
          src={ProjectImage}
          alt="campaign image"
        ...
        />
        <div className="absolute top-0 hidden md:flex flex-row justify-between items-center w-full p-4">
        ...
        <div className="absolute w-full h-[90px] py-2 px-4 bottom-0 hidden items-center justify-between group-hover:flex bg-[#01070E80] backdrop-blur-[4px] rounded-b-sm">
          <div className="flex flex-col items-start justify-start">
            ...
            <span className="flex flex-row w-full gap-1 items-center justify-start">
              ...
              <p className="text-white text-[12px]">Direccion del proyecto</p>
            </span>
          </div>
