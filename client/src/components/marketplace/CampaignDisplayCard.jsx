    ...
    <div className="md:max-w-[500px] w-full h-fit dark:bg-[#01070E] dark:bg-opacity-20 bg-[#F7FAFF] rounded-sm">
      <div className="flex flex-col flex-wrap relative">
        ...
        <div className="absolute top-0 flex flex-row justify-between items-center w-full p-3 font-jakarta">
          ...
          {userProfile && (
            <div className="bg-[#01070E80] backdrop-blur-sm p-1 rounded-md flex items-center cursor-pointer">
      ...
      <div className="mt-2 flex flex-col items-start justify-center w-full gap-2 px-3 dark:text-white text-[#062147] font-bold md:font-normal">
            ...
            <div
              ...
              style={{
                width: `${calculateBarPercentage(
                  testObjectiveAmount ? testObjectiveAmount : 0.5,
                  testAmountCollected ? testAmountCollected : 0.1
                )}%`,
                maxWidth: "100%",
              }}
            ></div>
        ...
        <div className="flex flex-row items-center justify-between gap-3 md:gap-4 w-full translate-y-[5px]">
          {[
            ...
            <div
              key={item.name}
              className="max-w-[60px] w-[30%] h-[50px] py-2 dark:bg-[#01070E] bg-[#F7FAFF] backdrop-blur-lg rounded-lg shadow-[0px_0px_10px_rgba(24,165,255,0.2)] flex flex-col items-center justify-center"
            >
      ...
      <div className="flex flex-col items-start justify-center w-full dark:text-white text-[#01070E] px-3 font-[400px] md:font-normal">
        <p className="leading-[20px] text-[14px] mt-4 w-[90%] font-jakarta truncate">
          {testDescription
            ? testDescription
