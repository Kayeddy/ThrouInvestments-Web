  ...
  return (
    <div className=" h-fit w-full flex flex-col items-center justify-start relative gap-12">
      ...
      <div className="w-full h-[480px] md:h-[570px] bg-[#062147] absolute bottom-[440px] md:bottom-[160px] p-4 px-[6%] overflow-hidden">
        <div className="flex flex-col md:flex-row items-center justify-between md:justify-start lg:gap-8 gap-12 relative h-full w-full pb-12">
          <div className="flex flex-col gap-2 items-start justify-center xl:w-[45%] w-full">
          ...
          <div className="flex flex-row items-center justify-center lg:gap-8 xl:gap-10 gap-4 z-20">
            <span className="px-1 py-3 md:p-4 lg:p-6 flex flex-col gap-4 items-center justify-between w-[170px] h-fit md:w-[180px] lg:w-[220px] xl:w-[230px] md:h-[230px] rounded-[30px] md:rounded-md text-center text-white text-[18px] md:text-[20px] font-Plus_Jakarta_Sans font-bold shadow-custom">
            ...
            <span className="px-1 py-3 md:p-4 lg:p-6 flex flex-col gap-4 items-center justify-between w-[170px] h-fit md:w-[180px] lg:w-[220px] xl:w-[230px] md:h-[230px] rounded-[30px] md:rounded-md text-center text-white md:text-[20px] font-Plus_Jakarta_Sans font-bold shadow-custom">
              <div className="flex flex-col gap-3 items-center">
                <span>
