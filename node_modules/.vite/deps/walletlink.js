...
import "./chunk-PKEN3KVR.js";
import "./chunk-IUTF2UZD.js";
...
var require_LinkDialog = __commonJS({
  "node_modules/walletlink/dist/components/LinkDialog.js"(exports2) {
    ...
    var CancelButton = (props) => (0, preact_1.h)(
      "button",
      { class: "-walletlink-link-dialog-box-cancel", onClick: props.onClick },
...
var require_TryExtensionLinkDialog = __commonJS({
  "node_modules/walletlink/dist/components/TryExtensionLinkDialog.js"(exports2) {
    ...
    var CancelButton = (props) => (0, preact_1.h)(
      "button",
      { class: "-walletlink-extension-dialog-box-cancel", onClick: props.onClick },
  ...
  "node_modules/walletlink/dist/components/Snackbar.js"(exports2) {
    ...
    var Snackbar = class {
      ...
      render() {
        ...
        (0, preact_1.render)((0, preact_1.h)(
          "div",
          null,
          (0, preact_1.h)(SnackbarContainer, { darkMode: this.darkMode }, Array.from(this.items.entries()).map(([key, itemProps]) => (0, preact_1.h)(SnackbarInstance, Object.assign({}, itemProps, { key }))))
        ), this.root);
      }
    };
    ...
    var SnackbarInstance = ({ autoExpand, message, menuItems }) => {
      ...
      return (0, preact_1.h)(
        ...
        (0, preact_1.h)(
          "div",
          { class: "-walletlink-snackbar-instance-header", onClick: toggleExpanded },
        ...
        menuItems && menuItems.length > 0 && (0, preact_1.h)("div", { class: "-walletlink-snackbar-instance-menu" }, menuItems.map((action, i) => (0, preact_1.h)(
          "div",
          { class: (0, clsx_1.default)("-walletlink-snackbar-instance-menu-item", action.isRed && "-walletlink-snackbar-instance-menu-item-is-red"), onClick: action.onClick, key: i },
          (0, preact_1.h)(
            "svg",
    ...
    var WalletLinkConnection = class {
      ...
      constructor(sessionId, sessionKey, serverUrl, walletLinkAnalytics, WebSocketClass = WebSocket) {
        ...
        this.subscriptions.add(ws.connectionState$.pipe(
          (0, operators_1.tap)((state) => this.walletLinkAnalytics.sendEvent(init_1.EVENTS.CONNECTED_STATE_CHANGE, {
            state,
    ...
    var WalletLinkRelay = class extends WalletLinkRelayAbstract_1.WalletLinkRelayAbstract {
      constructor(options) {
        ...
        this.subscriptions.add(
          this.connection.incomingEvent$.pipe((0, operators_1.filter)((m) => m.event === "Web3Response")).subscribe({ next: this.handleIncomingEvent })
        ...
        this.subscriptions.add(this.connection.sessionConfig$.pipe((0, operators_1.filter)((c) => c.metadata && c.metadata.WalletUsername !== void 0)).pipe((0, operators_1.mergeMap)((c) => aes256gcm.decrypt(c.metadata.WalletUsername, this._session.secret))).subscribe({
          next: (walletUsername) => {
        ...
        this.subscriptions.add(this.connection.sessionConfig$.pipe((0, operators_1.filter)((c) => c.metadata && c.metadata.AppVersion !== void 0)).pipe((0, operators_1.mergeMap)((c) => aes256gcm.decrypt(c.metadata.AppVersion, this._session.secret))).subscribe({
          next: (appVersion) => {
        ...
        this.subscriptions.add(this.connection.sessionConfig$.pipe((0, operators_1.filter)((c) => c.metadata && c.metadata.ChainId !== void 0 && c.metadata.JsonRpcUrl !== void 0)).pipe((0, operators_1.mergeMap)((c) => (0, rxjs_1.zip)(aes256gcm.decrypt(c.metadata.ChainId, this._session.secret), aes256gcm.decrypt(c.metadata.JsonRpcUrl, this._session.secret)))).pipe((0, operators_1.distinctUntilChanged)()).subscribe({
        ...
        this.subscriptions.add(this.connection.sessionConfig$.pipe((0, operators_1.filter)((c) => c.metadata && c.metadata.EthereumAddress !== void 0)).pipe((0, operators_1.mergeMap)((c) => aes256gcm.decrypt(c.metadata.EthereumAddress, this._session.secret))).subscribe({
