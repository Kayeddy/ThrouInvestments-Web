...
const CampaignsDisplay = ({ title, campaigns, loading }) => {
  ...
  return (
    <div className="mt-[110px] h-fit max-w-[1500px] mx-auto">
      <h1 className="font-epilogue font-semibold text-[25px] dark:text-white text-[#062147] text-left">
        Tendencias
      </h1>
      ...
      <div className="flex flex-col gap-12 items-center justify-center md:mb-[400px] mt-[100px] mb-[550px] w-full container">
        <div className="flex flex-row items-center justify-between w-full">
          ...
          <div className="flex flex-row gap-6 items-center justify-end w-fit">
            <CustomButton
              title="Filtrar"
              handleClick=""
              styles="h-fit w-[170px] p-2 border-1 dark:text-white text-[#062147] border-2 dark:border-[#B5B5B5] border-[#062147] rounded-none md:flex flex-row items-center justify-center gap-2 hidden"
              optionalIcon={Filter_icon}
            />
